...
public class Persona {
	...
	public String toString() {
		return "Persona [nombre=" + nombre + ", edad=" + edad + ", nss=" + nss + ", sexo=" + sexo + ", peso=" + peso
				+ ", altura=" + altura + ", sexoDefault=" + sexoDefault + ", faltaPeso=" + faltaPeso + ", pesoNormal="
				+ pesoNormal + ", sobrePeso=" + sobrePeso + "]";
	}
	...
	public String generaNSS() {
		...
		for(int i=0;i<8;i++) {
			if((int) (Math.random()*2+1)==1) 
				...
				nss+=(char)((int) (Math.random()*122+97));
		}
		return nss;
	}
